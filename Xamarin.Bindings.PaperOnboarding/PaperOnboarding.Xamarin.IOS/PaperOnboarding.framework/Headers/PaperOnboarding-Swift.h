...
SWIFT_CLASS_NAMED("GestureControl")
...
SWIFT_CLASS_NAMED("OnboardingItemInfoObjC")
@interface OnboardingItemInfoObjC : NSObject
- (nonnull instancetype)initWithInformationImage:(UIImage * _Nonnull)informationImage title:(NSString * _Nonnull)title description:(NSString * _Nonnull)description pageIcon:(UIImage * _Nonnull)pageIcon color:(UIColor * _Nonnull)color titleColor:(UIColor * _Nonnull)titleColor descriptionColor:(UIColor * _Nonnull)descriptionColor titleFont:(UIFont * _Nonnull)titleFont descriptionFont:(UIFont * _Nonnull)descriptionFont descriptionLabelPadding:(CGFloat)descriptionLabelPadding titleLabelPadding:(CGFloat)titleLabelPadding OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS_NAMED("PaperOnboarding")
...
- (nonnull instancetype)initWithPageViewBottomConstant:(CGFloat)pageViewBottomConstant OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_PROTOCOL_NAMED("PaperOnboardingDataSource")
...
- (OnboardingItemInfoObjC * _Nonnull)onboardingItemAt:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// color PageView Item
- (UIColor * _Nonnull)onboardingPageItemColorAt:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
/// Asks for the radius of the PageView item
///
/// returns:
/// radius of the PageView Item
- (CGFloat)onboardinPageItemRadius SWIFT_WARN_UNUSED_RESULT;
/// Asks for the selected state radius of the PageView item
///
/// returns:
/// selected state radius of the PageView Item
- (CGFloat)onboardingPageItemSelectedRadius SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_PROTOCOL_NAMED("PaperOnboardingDelegate")
...
/// Should <code>PaperOnboarding</code> react to taps on <code>PageControl</code> view.
/// If <code>true</code>, will scroll to tapped page.
@property (nonatomic, readonly) BOOL enableTapsOnPageControl;
@end
